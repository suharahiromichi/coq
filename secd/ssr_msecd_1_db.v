...
*)
  ...
  Proof.
    ...
    - move=> g' t1 t2 m n H1 IH1 H2 IH2 o He d H.
      inv: H => H5 H7.
      case: (IH1 o He d1 H5) => vd1 [H11 H12].
      inv: H11.
      case: (IH2 o He d2 H7) => vd2 [H21 H22].
      inv: H21.
      exists (vNat (m + n)).
      split => //.
    ...
    (* Let *)
    - move=> g' x g1 g2 v1 v2 H1 IH1 H2 IH2 o He d H.
      inv: H => H7 H8.
      case: (IH1 o He d1 H7) => vd1 [H11 H12].
      have He2 : dB_translation_NS_env ((x, v1) :: g') (vd1 :: o)
        by apply: dB_translation_NS_env_cons.
      have H82 : dB_translation_NS (mkctx ((x, v1) :: g')) g2 d2 by apply: H8.
      case: (IH2 (vd1 :: o) He2 d2 H82) => vd2 [H21 H22].
      exists vd2.
      split=> //.
        by apply: (MML_dB_NS_Let o d1 d2 vd1 vd2).
        
    (* If true *)
    - move=> g' t1 t2 t3 v2 H1 IH1 H2 IH2 o He d H.
      inv: H => H6 H8 H9.
      case: (IH1 o He d1 H6) => vd1 [H11 H12].
      inv: H11.
      case: (IH2 o He d2 H8) => vd2 [H21 H22].
      exists vd2.
      split=> //.
      apply: MML_dB_NS_Iftrue.
      invs: H12 => [m n H0 H5 H].
    ...
    (* If false *)
    - move=> g' t1 t2 t3 v3 H1 IH1 H3 IH3 o He d H.
      inv: H => H6 H8 H9.
      case: (IH1 o He d1 H6) => vd1 [H11 H12].
      inv: H11.
      case: (IH3 o He d3 H9) => vd3 [H31 H32].
      exists vd3.
      split=> //.
      apply: MML_dB_NS_Iffalse.
      invs: H12 => [m n H0 H5 H].
    ...
    (* App Clos *)
    - move=> g' g3 x t1 t2 t3 v2 v3 H1 IH1 H2 IH2 H3 IH3 o He d H.
      inv: H => H6 H8.
      case: (IH1 o He d1 H6) => vd1 [H11 H12] {IH1}. (* 関数部 *)
      inv: H11 => H9 H10.
      case: (IH2 o He d2 H8) => vd2 [H21 H22] {IH2}. (* 引数部 *)
      (* クロージャの中身を評価する環境 *)
      have He3 : dB_translation_NS_env ((x, v2) :: g3) (vd2 :: o0)
        by apply: dB_translation_NS_env_cons.
      (* クロージャの中身を変換する。 *)
      have H30 : dB_translation_NS (mkctx ((x, v2) :: g3)) t3 d by apply: H10.
      case: (IH3 (vd2 :: o0) He3 d H30) => vd3 [H31 H32] {IH3}.
      exists vd3.
      split=> //.
        by apply: MML_dB_NS_App; [apply: H12 | apply: H22 | apply: H32].
        
    (* App ClosRec *)
    - move=> g' g3 x f t1 t2 t3 v2 v3 H1 IH1 H2 IH2 H3 IH3 o He d H.
      inv: H => H6 H8.
      case: (IH1 o He d1 H6) => vd1 [H11 H12] {IH1}.
      move: (H11); inv=> H10 H13.           (* keepのために duplicate する。 *)
      case: (IH2 o He d2 H8) => vd2 [H21 H22] {IH2}.
      have He3 : dB_translation_NS_env
                   ((x, v2) :: (f, (VClosRec f x t3 g3)) :: g3)
                   (vd2 :: (vClosRec d o0) :: o0)
        by apply: dB_translation_NS_env_cons; [apply: dB_translation_NS_env_cons |].
      have H30 : dB_translation_NS
                   (mkctx ((x, v2) :: (f, VClosRec f x t3 g3) :: g3)) t3 d by [].
      case: (IH3 (vd2 :: (vClosRec d o0) :: o0) He3 d H30) => vd3 [H31 H32] {IH3}.
      exists vd3.
      split=> //.
