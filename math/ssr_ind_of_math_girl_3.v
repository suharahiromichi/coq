...
また、補題の証明に algebra tactic の field タクティクを使用しているので、
追加で algebra_tactic の導入が必要です。
...
https://github.com/suharahiromichi/coq/blob/master/math/ssr_ind_of_math_girl_3.v
*)

From mathcomp Require Import all_ssreflect.
From mathcomp Require Import all_algebra.
From mathcomp Require Import ring.          (* ring と field タクティク *)
Require Import Recdef.                      (* Function コマンド *)
Require Import Psatz.                       (* lia タクティク *)
...
その証明には、algebra_tactic/ring.vo を導入て field タクティクを使用します。
*)
...
- 最後に、それぞれに対して（完全）帰納法の仮定を適用することで得られた不等式は lia で片付けています。
*)
...
[6] Kazuhiko Sakaguchi and Pierre Roux, Algebra Tactics

https://github.com/math-comp/algebra-tactics


[7] Frédéric Besson and Evgeny Makarov, Micromega
